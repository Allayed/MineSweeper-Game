...
public class MineSweeperFixed {
   ...
   public static void main(String[] args) {
	  ...
	  MineField smine = new MineField(smallMineField);
	  VisibleField vsmine = new VisibleField(smine); 
      ...
      GameBoardPanel gameBoard = new GameBoardPanel(vsmine);
      ...
      System.out.println(vsmine.toString());
